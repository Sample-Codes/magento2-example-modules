...
class ShipAllItems extends Command
{
    ...
    {
        $this->setName("projecteight:examples:ship-order-line-items:ship-all-items");
        $this->setDescription("Demonstrates updating sales order lines by shipping all items in Magento 2");
        parent::configure();
    }
