 ...
 * @package     ProjectEight\ShipOrderLineItemsExample
 * @copyright   Copyright (c) 2017 ProjectEight
 * @author      ProjectEight
 *
 */

namespace ProjectEight\ShipOrderLineItemsExample\Command;
...
class ShipSelectedItems extends Command
{
    ...
    {
        $this->setName("projecteight:examples:ship-order-line-items:ship-selected-items");
        $this->setDescription("Demonstrates updating sales order lines by shipping selected items in Magento 2");
        parent::configure();
    }
