...
class WriteToAnotherLog
{
    ...
    /**
     * Write to log. By default writes to var/log/system.log
     *
     * @return \ProjectEight\CronExample\Cron\WriteToAnotherLog
     */
    public function execute()
    {
        $this->logger->info("This message came from " . __METHOD__);
