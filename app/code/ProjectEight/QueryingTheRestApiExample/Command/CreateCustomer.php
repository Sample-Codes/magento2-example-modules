...
class CreateCustomer extends Command
{
    ...
    {
        $this->setName("projecteight:examples:querying-the-rest-api:create-customer");
...
//        $command    = $this->getApplication()->find('projecteight:examples:querying-the-rest-api:get-admin-token');
